...
double Info::time() const
{																																																																// returns either elapsed time or remaining time
...
void Info::print_logo() const
{
	...
	print(".-----------------------------------------------------------------------------.\n");
	print("|                       ");
	print("______________   ", a);
	print("______________", b);
	print("                       |\n");
	print("|                       ");
	print("\\   ________  | ", a);
	print("|  ________   /", b);
	...
	print("|                                     ");
	print("\\ /", c);
	print("                FluidX3D Version 2.6 |\n");
	print("|                                      ");
	print("'", c);
	print("         Copyright (c) Moritz Lehmann |\n");
}
...
void Info::print_update() const
{
	...
	{ // print camera settings
		...
		if (camera.free)
			print_info("lbm.graphics.set_camera_free(" + camera_position + ", " + camera_rx_ry_fov + ");");
		else
			print_info("lbm.graphics.set_camera_centered(" + camera_rx_ry_fov + ", " + camera_zoom + ");");
		key_G = false;
	}
#endif // GRAPHICS
}
